...
export const PK_CITIES: PkCity[] = [
  ...
  },
  {
    ...
    areas: [
      ...
      { name: 'Chaklala Scheme III',    lat: 33.5660, lng: 73.0817 },
      { name: 'Adiala',                 lat: 33.4914, lng: 72.9866 },
      { name: 'Murree Road',            lat: 33.6188, lng: 73.0671 },
      { name: 'Faizabad',               lat: 33.6611, lng: 73.0789 },
      { name: 'Committee Chowk',        lat: 33.6076, lng: 73.0680 },
      { name: 'Raja Bazaar',            lat: 33.5994, lng: 73.0457 },
      { name: 'Asghar Mall',            lat: 33.6053, lng: 73.0644 },
      { name: 'Tench Bhata',            lat: 33.5832, lng: 73.0578 },
      { name: 'Khanna Pul',             lat: 33.6473, lng: 73.1126 },
      { name: 'Pir Wadhai',             lat: 33.6196, lng: 73.0148 },
      { name: 'Naseerabad',             lat: 33.5917, lng: 73.0335 },
      { name: 'Iqbal Town RWP',         lat: 33.5783, lng: 73.0354 },
      { name: 'Gulshanabad',            lat: 33.5462, lng: 73.0738 },
      { name: 'Gulrez Housing Scheme',  lat: 33.5350, lng: 73.0780 },
      { name: 'Range Road',             lat: 33.5836, lng: 73.0670 },
      { name: 'College Road',           lat: 33.6021, lng: 73.0703 },
      { name: 'Morgah',                 lat: 33.5413, lng: 73.0640 },
      { name: 'Dhamial',                lat: 33.5510, lng: 73.0150 },
      { name: 'Lalkurti',               lat: 33.5947, lng: 73.0500 },
      { name: 'Misrial Road',           lat: 33.5945, lng: 73.0030 },
      { name: 'Ojhri',                  lat: 33.6020, lng: 73.0780 },
      { name: 'Peshawar Road',          lat: 33.5934, lng: 73.0244 },
      { name: 'Tulsa Road',             lat: 33.5790, lng: 73.0790 },
      { name: 'Airport Housing',        lat: 33.5290, lng: 73.1320 },
      { name: 'Dhok Kala Khan',         lat: 33.6155, lng: 73.0780 },
    ],
  },
  {
    name: 'Lahore',
